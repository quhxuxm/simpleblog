...
public interface IAuthorPojoMapper {
    Author findOneByAuthenticationId(@Param("authenticationId") long authenticationId);
    ...
    void assignDefaultAnthology(@Param("authorId") long authorId, @Param("anthologyId") long anthologyId);
}
