...
public class TestRepository {
    ...
    @Test
    public void test() {
        Authentication auth1 = this.authenticationMapper
                .findAuthenticateByToken("1@1.com");
        ...
        Authentication auth2 = this.authenticationMapper
                .findAuthenticateByToken("2@1.com");
        Set<Role> auth2Roles = auth2.getRoles();
        for (Role role : auth2Roles) {
            System.out.println(role.getName());
        }
        System.out.println(auth2.getRegisterDate());
        Author author1 = this.authorMapper
                .findAuthorByAuthentication(auth1.getId());
